...
一键保存浏览器标签页为 Markdown 文件，支持弹窗按钮和右键菜单两种操作方式。

## 功能

### 弹窗按钮
- 点击扩展图标，弹出窗口显示当前窗口的标签页数量
- 点击 **"保存全部标签页"** 按钮，生成 Markdown 文件并下载

### 右键菜单
- 在任意网页上右键，选择 **"复制此标签页链接"** → 剪贴板写入 `- [标题](URL)`
- 选择 **"保存全部标签页为 Markdown"** → 下载当前窗口全部标签页
...
### 方式二：右键菜单
1. 在任意网页上 **右键**
2. 选择 **"复制此标签页链接"** — 链接写入剪贴板，直接粘贴
3. 或选择 **"保存全部标签页为 Markdown"** — 下载当前窗口全部
